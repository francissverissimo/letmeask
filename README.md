...
<p align="center">
  <img alt="Letmeask Home" src=".github/print1.png" />
...
The application is available in your browser at "localhost:3000".

Remembering that you will need to create a [Firebase](https://firebase.google.com/) account and a project to provide a Realtime Database.
